...
const servicpost = [{img:muz1,title:'Музыкальный салон (105 м2)', price:'3000',scope:"Услуги по организации и проведению мероприятий в Музыкальном салоне (творческих и поэтических вечеров, презентаций) 3000 руб/час; Фотосессия 1200 руб/час",priceincl: 'Белый рояль (закрытый), 8 мраморных столов, 24 посадочных места, Рояль открывается только для музыкальных вечеров'},{img:holl,title:'Холл первого этажа (356 м2)', price:'3000',scope:"Услуги по организации и проведению мероприятий (выставок изобразительного и декоративно-прикладного искусства, фотовыставок, презентаций, мастер-классов, танцевальных мероприятий)",priceincl: 'Столы для регистрации с накидками до 3 шт, Столы  до 25шт, Стулья до 50шт, '},{img:holl2,title:'Конференц-зал (этноковоркинг) (56 м2)', price:'1200',scope:"Услуги по организации и проведению мероприятий в конференц-зале (мультимедийных презентаций, семинаров, совещаний, лекций) 1200 руб/час",priceincl: ''},{img:torg,title:'Зал торжественных мероприятий (509 м2)', price:'9000',scope:"Услуги по организации и проведению мероприятий в Зале торжественных мероприятий 9000 руб/час; Услуги по организации и проведению мероприятий в Зале торжественных мероприятий с предоставлением светодиодного экрана размерами 7*4 метра (1 этаж, 509,9 кв.м.) 14000 руб/час",priceincl: 'Звуковое сопровождение мероприятия, Радиосистема кибинированая'},{img:mnfunc,title:'Многофункциональный зал (270 м2)', price:'4800',scope:"Услуги по организации и проведению мероприятий в Многофункциональном зале вместимостью:; концертный вариант до 230 человекпроведение; бала/дискотеки до 150-200 человек 4800 руб/час; Услуги по организации и проведению мероприятий в Многофункциональном зале с предоставлением светодиодного экрана вместимостью:; концертный вариант до 230 человекпроведение; бала/дискотеки до 150-200 человек 7800 руб/час; Услуги по организации и проведению мероприятий в Учебном классе 1200 руб/час",priceincl: 'Звуковое сопровождение мероприятия, 2 радио микрофона на стойках, Видео сопровождение мероприятия (2 плазменные панели), Работа специалиста по видео сопровождению мероприятия, Стулья/столы на количество гостей'}, 
{img: minizal,title: 'Малый зал (263 м2)', price:'3300', scope: 'Услуги по организации и проведению мероприятий в Малом зале вместимостью в режиме конференции, концерта, бизнес-семинаров, презентаций (до 130 человек) 3300 руб/час; Услуги по организации и проведению мероприятий в Малом зале вместимостью в режиме банкета до 50-130 человек 2500 руб/час; Услуги по организации и проведению мероприятий в Малом зале вместимостью в режиме фуршета до 200 человек 2500 руб/час ',priceincl:'Звуковое сопровождение мероприятия, 2 микрофона на стойках, Видео сопровождение мероприятия (1 плазменная панель), работа специалиста по видео сопровождению мероприятия, Столы/стулья на количество гостей для конференции или круглого стола' }];
