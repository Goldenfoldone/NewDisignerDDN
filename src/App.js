...
import { ReviewsAll } from './components/adminPanel/ReviewsAll';
...
const servicpost = [
    ...
    priceincl: 'Белый рояль (закрытый), 8 мраморных столов, 24 банкетки, Рояль открывается только для музыкальных вечеров'},
  {
    ...
    price:'3000',
    scope:"Услуги по организации и проведению мероприятий (выставок изобразительного и декоративно-прикладного искусства, фотовыставок, презентаций, мастер-классов, танцевальных мероприятий) - 3000 руб/час",
    ...
    <>
      <Routes>
        ...
        <Route path={Pahts.admin} element={<PrivateRouter><AdminMenu> <Outlet /> </AdminMenu></PrivateRouter>}>
          ...
          <Route path={Pahts.reviews} element={<ReviewsAll/>}/>
