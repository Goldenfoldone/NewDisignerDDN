...
export const Structure = () => {
    ...
    const administration2 =[{name:'Заместитель директора по основной деятельности', url:Pahts_administration.deputy_director_2},{name:'Отдел организации мероприятий и взаимодействия с национально-культурными объединениями', url:Pahts_administration.depertment_relations},{name:' Отдел этнокультурного просвещения и языковых практик', url:Pahts_administration.department_events},{name:'Отдел по работе с муниципальными образованиями', url:Pahts_administration.departnent_education},{name:'Отдел молодёжных инициатив и общественных проектов', url:Pahts_administration.department_project},{name:'Информационно-аналитический отдел', url:Pahts_administration.department_info},{name:'Отдел администрирования ресурсов', url:Pahts_administration.department_admin_res}]
    return(
        <MainStructyr>
